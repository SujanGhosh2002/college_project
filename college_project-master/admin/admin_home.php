                    ...
                    <div class="left-box left-bottom-box">
                        <div class="left-bottom-box-top">
                            <div class="top-box-left">
                                ...
                                <div class="top-box-bottom">
                                    <h3>playlist</h3>
                                    <button class="btn" type="button"> <a href="add_playlist.php">add</a></button>
                                </div>
                            </div>
                            <div class="top-box-right">
                                ...
                                <div class="top-box-bottom">
                                    <h3>video</h3>
                                    <button class="btn" type="button"><a href="add_content.php">add</a></button>
                                </div>
                            </div>
                        </div>
                        <div class="left-bottom-box-bottom">
                            ...
                            <div class="bottom-box-bottom">
                                <h3>document</h3>
                                <button class="btn" type="button"><a href="add_document.php">add</a></button>
                            </div>
                        </div>
                    </div>
